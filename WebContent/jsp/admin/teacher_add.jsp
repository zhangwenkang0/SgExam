			...
			<div class="main-wrap">
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						...
						<a class="crumb-name" href="jsp/admin/news_list.jsp">教师管理</a><span class="crumb-step">&gt;</span><span>添加教师</span>
					</div>
				</div>
				<div class="result-wrap">
					<div class="result-content">
						<form action="ManageTeacherServlet?flag=add&pageNum=1" method="post" id="myform" name="myform">
							<table class="insert-tab" width="100%">
								<tbody>
									<tr>
										<th><i class="require-red">*</i>教师编号：</th>
										<td>
											<input class="common-text required" id="title" name="t_id" size="50" value="" type="text">
										</td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>姓名：</th>
										<td><input class="common-text required" id="people" name="t_name" size="50" value="" type="text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>密码：</th>
										<td><input class="common-text required" id="people" name="t_pass" size="50" value="" type="text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>职称：</th>
										<td>
											<input class="common-text required" id="people" name="t_Job" size="50" value="" type="text">
										</td>
									</tr>
									<tr>
										<th></th>
