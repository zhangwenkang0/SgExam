			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						...
						href="jsp/admin/news_list.jsp">学生管理</a><span class="crumb-step">&gt;</span><span>添加学生</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form
						action="ManageStudentServlet?flag=add&pageNum=1"
							...
							<tbody>
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="s_id" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>姓名：</th>
									<td><input class="common-text required" id="people"
										name="s_name" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>密码：</th>
									<td><input class="common-text required" id="people"
										name="s_pass" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>性别：</th>
									<td><label><input class="common-text required" id="people"
										name="s_sex" size="50" value="1" type="radio" checked="checked">男</label>
										<label><input class="common-text required" id="people"
										name="s_sex" size="50" value="2" type="radio">女</label></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>班级：</th>
									<td><input class="common-text required" id="people"
										name="cls_id" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th></th>
