...
$(function(){
	...
	with (document.getElementById("page")) {  
	    method = "post";  
	    action = "servlet/ManageQuestion.do?flag=find&manager=admin&pager="+page;
	    submit();  
		}  
		 }
			...
			<!--/sidebar-->
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						<a href="jsp/admin/index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">考试管理</span></div>
				</div>
					...
					<form name="myform" id="myform" method="post">
						<div class="result-title">
							<div class="result-list">
								<a href="jsp/admin/test_add.jsp"><i class="icon-font"></i>添加考试</a>
