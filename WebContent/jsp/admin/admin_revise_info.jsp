			...
			<div class="main-wrap">
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						...
						<a class="crumb-name" href="jsp/admin/news_list.jsp">管理员管理</a><span class="crumb-step">&gt;</span><span>修改信息</span>
					</div>
				</div>
				<div class="result-wrap">
					<div class="result-content">
						<form action="ManageAdminServlet?flag=update&pageNum=1" method="post" id="myform" name="myform">
							<table class="insert-tab" width="100%">
								<tbody>
									<tr>
										<th><i class="require-red">*</i>用户账号：</th>
										<td>
											<input class="common-text required" id="title" name="m_id" size="50" value="<%=request.getParameter("m_id") %>" type="text" readonly="readonly">
										</td>
									</tr>
									
									<tr>
										<th><i class="require-red">*</i>姓名：</th>
										<td><input class="common-text required" id="people" name="m_name" size="50" value="<%=request.getParameter("m_name") %>" type="text"></td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>密码：</th>
										<td><input class="common-text required" id="newpassword" name="m_pass" size="50" value="<%=request.getParameter("m_pass") %>" type="text"></td>
									</tr>
									<tr>
										<th></th>
										<td>
