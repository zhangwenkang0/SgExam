			...
			<div class="main-wrap">
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						...
						<a class="crumb-name" href="jsp/teacher/news_list.jsp">消息中心</a><span class="crumb-step">&gt;</span><span>修改消息</span>
					</div>
				</div>
				<div class="result-wrap">
					<div class="result-content">
						<form action="DoUpdateAnnouncementServlet?operation=update" method="post" id="myform" name="myform">
							<table class="insert-tab" width="100%">
								<tbody>
									<tr>
										<th><i class="require-red">*</i>标题：</th>
										<td>
											<input class="common-text required" id="title" name="a_title" size="50" value="${news.a_title}" type="text">
										</td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>内容：</th>
										<td>
											<textarea name="a_content" class="common-textarea" id="a_content" cols="30" style="width: 98%;" rows="10">${news.a_content }</textarea>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input class="common-text required" id="startTime" name="startTime" size="50" value="${news.a_startTime }" type="date" >
										</td>
									</tr>
									<tr>
										<th><i class="require-red">*</i>有效结束时间：</th>
										<td>
											<input class="common-text required" id="endTime" name="endTime" size="50" value="${news.a_endTime }" type="date" >
										</td>
									</tr>
									<tr>
										<th></th>
										<td>
											<input type="hidden" name="a_id" value="${news.a_id }">
